  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <a href="https://aviasales.tpx.gr/EDLTCi50" target="_blank" onClick={() => trackClick()} 
        ...
        🚀 FLASH SALE: UP TO 50% OFF FLIGHTS & HOTELS — CLICK HERE
      </a>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden border-b border-border">
        ...
        <img
          ...
          alt="Elegant traveller arriving at a luxury hotel"
          className="absolute inset-0 w-full h-full object-cover object-center"
        />
        {/* Warm cinematic overlay — protects text readability */}
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-6 py-32 text-left">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
            ...
            Travel With <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFD23F] to-[#FF6B35] italic">FASTAMOR</span>
          </motion.h1>
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
            className="text-lg md:text-xl text-white/85 max-w-xl mb-10 font-medium leading-relaxed">
            Skip the endless searching. Tell our AI where you want to go, and instantly get the best prices on flights, hotels, and tours across 200+ providers.
          </motion.p>
        ...
        <div className="flex gap-8 whitespace-nowrap px-4 animate-marquee">
          {[1,2].map(k => (
            <div key={k} className="flex gap-12 items-center">
              <a href="https://aviasales.tpx.gr/EDLTCi50" target="_blank" onClick={() => trackClick()} className="flex items-center gap-2 text-foreground hover:text-primary transition-colors font-bold uppercase tracking-wider text-sm"><Plane size={16} className="text-primary"/> Cheap Flights</a>
              <a href="https://booking.tpx.gr/EWmbrXYx" target="_blank" onClick={() => trackClick()} className="flex items-center gap-2 text-foreground hover:text-secondary transition-colors font-bold uppercase tracking-wider text-sm"><Building2 size={16} className="text-secondary"/> Top Hotels</a>
              <a href="https://getyourguide.tpx.gr/XMdfzvoV" target="_blank" onClick={() => trackClick()} className="flex items-center gap-2 text-foreground hover:text-accent transition-colors font-bold uppercase tracking-wider text-sm"><Ticket size={16} className="text-accent"/> Experiences</a>
              <a href="https://searadar.tpx.gr/PdA1Y1ul" target="_blank" onClick={() => trackClick()} className="flex items-center gap-2 text-foreground hover:text-info transition-colors font-bold uppercase tracking-wider text-sm"><Ship size={16} className="text-info"/> Cruises</a>
              <a href="https://discovercars.tpx.gr/9pGzpviq" target="_blank" onClick={() => trackClick()} className="flex items-center gap-2 text-foreground hover:text-primary transition-colors font-bold uppercase tracking-wider text-sm"><Car size={16} className="text-primary"/> Car Rental</a>
              <a href="https://omio.tpx.gr/HhKpT0j2" target="_blank" onClick={() => trackClick()} className="flex items-center gap-2 text-foreground hover:text-secondary transition-colors font-bold uppercase tracking-wider text-sm"><Train size={16} className="text-secondary"/> Trains & Buses</a>
            </div>
          ))}
        </div>
      </div>
      ...
      <section id="services" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-serif font-black text-foreground mb-4">Book Everything.</h2>
          <p className="text-muted text-lg font-medium">Your entire itinerary handled in one smart interface.</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <button onClick={() => onOpenApp('flight')} className="group relative h-48 md:h-64 rounded-3xl overflow-hidden shadow-lg border border-border text-left">
            <img src={`${import.meta.env.BASE_URL}images/flight-scenic.png`} className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="Flights" />
            ...
            <div className="absolute bottom-6 left-6">
              ...
              <h3 className="text-xl font-black text-white drop-shadow-md">Flights</h3>
            </div>
          </button>
          ...
          <button onClick={() => onOpenApp('hotel')} className="group relative h-48 md:h-64 rounded-3xl overflow-hidden shadow-lg border border-border text-left">
            <img src={`${import.meta.env.BASE_URL}images/hotel-luxury.png`} className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="Hotels" />
            ...
            <div className="absolute bottom-6 left-6">
              ...
              <h3 className="text-xl font-black text-white drop-shadow-md">Hotels</h3>
            </div>
          </button>
          ...
          <button onClick={() => onOpenApp('experience')} className="group relative h-48 md:h-64 rounded-3xl overflow-hidden shadow-lg border border-border text-left">
            <img src={`${import.meta.env.BASE_URL}images/tour-experience.png`} className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="Tours" />
            ...
            <div className="absolute bottom-6 left-6">
              ...
              <h3 className="text-xl font-black text-white drop-shadow-md">Tours</h3>
            </div>
          </button>
          ...
          <button onClick={() => onOpenApp('taxi')} className="group relative h-48 md:h-64 rounded-3xl overflow-hidden shadow-lg border border-border text-left">
            <img src={`${import.meta.env.BASE_URL}images/taxi-transfer.png`} className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="Transfers" />
            ...
            <div className="absolute bottom-6 left-6">
              ...
              <h3 className="text-xl font-black text-white drop-shadow-md">Transfers</h3>
            </div>
          </button>
          ...
          <a href="https://searadar.tpx.gr/PdA1Y1ul" target="_blank" onClick={() => trackClick()} className="group relative h-48 md:h-64 rounded-3xl overflow-hidden shadow-lg border border-border text-left md:col-span-2">
            <div className="absolute inset-0 bg-gradient-to-br from-[#3A86FF] to-[#00C9B1] group-hover:scale-105 transition-transform duration-700 opacity-90" />
            ...
            <div className="absolute bottom-6 left-6 z-10">
              ...
              <h3 className="text-xl font-black text-white mb-1 drop-shadow-sm">Cruises</h3>
          ...
          <a href="https://hotels.tpx.gr/HZcgZ2jB" target="_blank" onClick={() => trackClick()} className="group relative h-48 md:h-64 rounded-3xl overflow-hidden shadow-lg border border-border text-left md:col-span-2">
            <div className="absolute inset-0 bg-gradient-to-br from-[#FF6B35] to-[#FFD23F] group-hover:scale-105 transition-transform duration-700 opacity-90" />
            <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-20"></div>
            <div className="absolute bottom-6 left-6 z-10">
              ...
              <h3 className="text-xl font-black text-white mb-1 drop-shadow-sm">Luxury Resorts</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Tell Fastamor</h3>
              <p className="text-muted font-medium">Just type or speak naturally. "Find me a cheap flight to Paris next Friday."</p>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">AI Searches</h3>
              <p className="text-muted font-medium">In seconds, we scan 200+ providers across the web to find the hidden gems.</p>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Book Direct</h3>
              <p className="text-muted font-medium">Click the links to book directly with the provider. Zero hidden fees from us.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="destinations" className="py-24 px-4 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <a href="https://aviasales.tpx.gr/EDLTCi50" target="_blank" onClick={() => trackClick()} className="md:col-span-2 group rounded-3xl overflow-hidden relative h-[400px] shadow-lg">
            <img src={`${import.meta.env.BASE_URL}images/flight-scenic.png`} className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt="Flights" />
          ...
          <div className="space-y-6">
            <a href="https://booking.tpx.gr/EWmbrXYx" target="_blank" onClick={() => trackClick()} className="block group rounded-3xl overflow-hidden relative h-[188px] shadow-lg">
              <img src={`${import.meta.env.BASE_URL}images/hotel-luxury.png`} className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt="Hotels" />
            ...
            <a href="https://discovercars.tpx.gr/9pGzpviq" target="_blank" onClick={() => trackClick()} className="block group rounded-3xl overflow-hidden relative h-[188px] shadow-lg">
              <img src={`${import.meta.env.BASE_URL}images/taxi-transfer.png`} className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt="Cars" />
              <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-colors"></div>
              <div className="absolute bottom-6 left-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><button onClick={() => onOpenApp('flight')} className="text-white/60 hover:text-white transition-colors text-sm font-medium">Flights</button></li>
                <li><button onClick={() => onOpenApp('hotel')} className="text-white/60 hover:text-white transition-colors text-sm font-medium">Hotels</button></li>
                <li><button onClick={() => onOpenApp('taxi')} className="text-white/60 hover:text-white transition-colors text-sm font-medium">Transfers</button></li>
                <li><button onClick={() => onOpenApp('experience')} className="text-white/60 hover:text-white transition-colors text-sm font-medium">Tours & Activities</button></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><button onClick={onOpenPrivacy} className="text-white/60 hover:text-white transition-colors text-sm font-medium">Privacy Policy</button></li>
                <li><a href="mailto:contact@fastamor.com" className="text-white/60 hover:text-white transition-colors text-sm font-medium">Contact Us</a></li>
              </ul>
            </div>
          </div>
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-white/60 text-sm cursor-pointer select-none font-medium" onClick={adminTrigger}>© 2026 Fastamor. All rights reserved.</p>
            <p className="text-white/40 text-xs font-medium">Powered by Travelpayouts</p>
          </div>
        </div>
      </footer>
    </div>
